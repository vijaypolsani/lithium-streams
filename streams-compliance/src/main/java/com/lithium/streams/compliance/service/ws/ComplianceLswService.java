...
@Path("/v1")
public class ComplianceLswService {

	private static final Logger log = LoggerFactory.getLogger(ComplianceLswService.class);
	//private static final String COMMUNITY_NAME = "actiance";
	private static final String COMMUNITY_NAME = "lsw";
