...
public class SimpleExample {
	...
	public void run(long a_maxReads, String a_topic, int a_partition, List<String> a_seedBrokers, int a_port)
		...
		while (a_maxReads > 0) {
			...
			//System.out.println("Consumer Created: " + consumer.toString());
			FetchRequest req = new FetchRequestBuilder().clientId(clientName).addFetch(a_topic, a_partition,
					readOffset, 1024000) // Note: this fetchSize of 100000 might need to be increased if large batches are written to Kafka
					.build();
