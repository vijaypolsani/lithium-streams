...
public class EncryptionMain {
	...
	//private final static String samplePayload = "TESTMESSAGE";
	private final static SecureEvent inputEvent = new Payload(samplePayload.getBytes(StandardCharsets.UTF_8));
	private static final ApplicationContext context = new ClassPathXmlApplicationContext(
			"classpath:/spring/commonContext.xml");
	private static final Logger log = LoggerFactory.getLogger(EncryptionMain.class);
